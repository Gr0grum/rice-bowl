...
## Type: Dict
# c.bindings.key_mappings = {'<Enter>': '<Return>', '<Ctrl-M>': '<Return>', '<Ctrl-[>': '<Escape>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-6>': '<Ctrl-^>', '<Shift-Enter>': '<Return>', '<Ctrl-J>': '<Return>', '<Shift-Return>': '<Return>'}
